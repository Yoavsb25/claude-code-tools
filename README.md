...
| [job-search](./tools/job-search/) | tool | career | advanced | Runs the end-to-end job hunt: queries job-board APIs, LinkedIn, company ATS feeds and career pages (with an optional Apify Workday fallback), tracks applications, and kicks off resume-tailor |
