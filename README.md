...
| [job-search](./tools/job-search/) | tool | career | advanced | Runs the end-to-end job hunt: queries job-board APIs, company ATS feeds, and career pages, tracks applications via a bookkeeping script, and kicks off resume-tailor for shortlisted roles |
