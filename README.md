...
| [job-search](./tools/job-search/) | tool | career | advanced | Runs the end-to-end job hunt: finds and ranks matching openings against a personalized profile, tracks applications via a bookkeeping script, and kicks off resume-tailor for shortlisted roles |
