...
| [job-search](./tools/job-search/) | tool | career | advanced | Runs the end-to-end job hunt: queries job-board APIs and the web for matching openings, tracks applications via a bookkeeping script, and kicks off resume-tailor for shortlisted roles |
