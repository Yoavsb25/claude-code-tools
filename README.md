...
| [rnd-catalogue](./tools/rnd-catalogue/) | tool | career | intermediate | Inventories every open Engineering/Product/Data role at watchlisted companies (shared with job-search) in London/remote-UK, with new/closed diffing across runs |
...
| [job-search](./tools/job-search/) | tool | career | advanced | Runs the end-to-end job hunt: queries job-board APIs, LinkedIn, ATS feeds and career pages, tracks applications, kicks off resume-tailor, and surfaces warm-intro connections at target companies |
