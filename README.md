...
| [job-search](./tools/job-search/) | tool | career | advanced | Runs the end-to-end job hunt: queries job-board APIs, LinkedIn, ATS feeds and career pages, tracks applications, surfaces worth-exploring roles at target companies, and kicks off resume-tailor |
